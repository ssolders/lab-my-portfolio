const c = [
	...
	() => import("../../src/routes/project/__layout.svelte"),
...
export const routes = [
	...
	[/^\/projects\/?$/, [c[0], c[3], c[4]], [c[1]], null, 'projects'],

	// src/routes/project/[slug].svelte
	[/^\/project\/([^/]+?)\/?$/, [c[0], c[5], c[6]], [c[1]], (m) => ({ slug: d(m[1])}), 'project/[slug]'],

	// src/routes/admin/index.svelte
	[/^\/admin\/?$/, [c[7], c[8]], [], null, 'admin']
];
